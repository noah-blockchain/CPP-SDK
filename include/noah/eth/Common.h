...
NOAH_TX_API extern char const* Version;

NOAH_TX_API extern std::string const EmptyString;
...
NOAH_TX_API extern bytes const NullBytes;
...
class NOAH_TX_API HasInvariants
{
public:
...
NOAH_TX_API int64_t utcTime();

NOAH_TX_API void setDefaultOrCLocale();
...
NOAH_TX_API bool isTrue(std::string const& _m);
NOAH_TX_API bool isFalse(std::string const& _m);
}  // namespace dev
