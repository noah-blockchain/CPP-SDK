...
NOAH_TX_API extern bytes RLPNull;

/// The empty list in RLP format.
NOAH_TX_API extern bytes RLPEmptyList;

/// Human readable version of RLP.
NOAH_TX_API std::ostream& operator<<(std::ostream& _out, dev::RLP const& _d);
